...
set paths_array(req_time,1) {14.452}
set paths_array(slack,1) {-2.550}
set paths_array(TS,1) {}
set paths_array(start_point,1) {sobel_inst/proc_index[1]}
set paths_array(end_clk_dly,1) {0.000}
set paths_array(start_clock,1) {sobel_top|clock:rising}
set paths_array(skew,1) {0.0}
set paths_array(sig) {/home/icl5712/GitHub/CE387/Lab4/sv/proj_1.prj|rev_1 {} /home/icl5712/GitHub/CE387/Lab4/sv/rev_1/sdc_verif_slack.itd correlate 1 slack 1 {} {} {} {} {} {} 0 1 0 1 1}
...
set sort_list {1 NA}
set clock_list {}
set foo {ctd_ta_point,sobel_inst/proc_index[1]}
set ta_array($foo) {sobel_inst.proc_index[1]}
set foo {ctd_ta_point,fifo_out_inst/fifo_buf}
set ta_array($foo) {fifo_out_inst.fifo_buf}
puts ""
