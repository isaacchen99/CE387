...
set paths_array(req_time,1) {11.258}
set paths_array(slack,1) {-1.987}
set paths_array(TS,1) {}
set paths_array(start_point,1) {a_inst/mem}
set paths_array(end_clk_dly,1) {0.000}
set paths_array(start_clock,1) {matmul_top|clock:rising}
set paths_array(skew,1) {0.0}
set paths_array(sig) {/home/icl5712/GitHub/CE387/Lab2/proj_1.prj|rev_1 {} /home/icl5712/GitHub/CE387/Lab2/rev_1/sdc_verif_slack.itd correlate 1 slack 1 {} {} {} {} {} {} 0 1 0 1 1}
...
set sort_list {1 NA}
set clock_list {}
set foo {ctd_ta_point,a_inst/mem}
set ta_array($foo) {a_inst.mem}
set foo {ctd_ta_point,matmul_inst/accum[31]}
set ta_array($foo) {matmul_inst.accum[31]}
puts ""
