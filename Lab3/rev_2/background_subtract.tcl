...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|motion_detect_tb"
...
set_global_assignment -section_id motion_detect_tb -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "background_subtract.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "motion_detect_tb" 
